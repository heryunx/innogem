...
import EstimatedCostModal from "@/components/layout/dashboard/estimated-dialog";
        ...
        <CardContent className="p-4">
          ...
          <div className="w-full flex gap-4 justify-center sm:justify-end mt-4">
            <Button
              variant="outline"
              className="gap-2"
              onClick={() => setOpenEstimated(true)}
            >
              <Eye className="h-4 w-4" />
              View Estimated Cost Product
            </Button>

            <EstimatedCostModal
              estimatedProducts={estimatedProducts}
              open={openEstimated}
              onOpenChange={setOpenEstimated}
            />
