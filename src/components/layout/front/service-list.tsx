  ...
  return (
    <div className="px-4 py-10 max-w-7xl mx-auto text-center">
      <div className="flex flex-col justify-center items-center">
        <h2 className="text-3xl font-bold mb-4 text-darken">
          ...
          >
            ...
            <div className="mt-auto mb-auto relative z-10">
              ...
              <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                <div
                  className={`w-12 h-12 sm:w-14 sm:h-14 md:w-24 md:h-24 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center text-xl md:text-2xl inset-shadow-2xs transition-transform duration-300 ${
